...
local Disabled={
	...
	Assistans		=function()
					...
					IsCollectibleUnlocked(300) or	--Smuggler
					IsCollectibleUnlocked(9745) or	--Armorer
					IsCollectibleUnlocked(10184)	--Ragpicker
					)
					end,
	Banker		=function()return not(IsCollectibleUnlocked(267) or IsCollectibleUnlocked(6376) or IsCollectibleUnlocked(8994))end,
	Trader		=function()return not(IsCollectibleUnlocked(301) or IsCollectibleUnlocked(6378) or IsCollectibleUnlocked(8995))end,
	Smuggler	=function()return not IsCollectibleUnlocked(300) end,
	Armorer		=function()return not IsCollectibleUnlocked(9745) end,
	Ragpicker	=function()return not IsCollectibleUnlocked(10184) end,
...
--]]
	...
	var		="Banker",
	disabled	=function()return not (IsCollectibleUnlocked(267) or IsCollectibleUnlocked(6376) or IsCollectibleUnlocked(8994)) end
	},
	{	--Trader
	...
	var		="Trader",
	disabled	=function()return not (IsCollectibleUnlocked(301) or IsCollectibleUnlocked(6378) or IsCollectibleUnlocked(8995)) end
	},
	{	--Smuggler
	...
	func		=function()UseCollectible(9745) SCENE_MANAGER:SetInUIMode()end,
	tooltip	="Armorer",
	var		="Armorer",
	disabled	=function()return not IsCollectibleUnlocked(9745) end
	},
	{	--Ragpicker
	icon		="esoui/art/crafting/gamepad/gp_crafting_menuicon_deconstruct.dds",
	func		=function()UseCollectible(10184) SCENE_MANAGER:SetInUIMode()end,
	tooltip	="Ragpicker",
	var		="Ragpicker",
	disabled	=function()return not IsCollectibleUnlocked(10184) end
	},
--[[
	{	--Jubilee event
